...
def main():
    ...
    caption2 = font2.render("Punchy Maggie", True, (0,0,0))
    ...
    caption1=font1.render("Two Dogs",True,(48,213,200))
    # Prepare the music
    ...
    while True:
        ...
        x = screen.get_width()-caption2.get_width()*1.5
        y = image.get_height()-470
